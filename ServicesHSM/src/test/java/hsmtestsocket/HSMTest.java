...
public class HSMTest {
	...
	protected StringBuffer clearData;
	protected StringBuffer encodedData;
	protected StringBuffer translatedData;
	...
	public HSMTest() {
		clearData = new StringBuffer(
//				"MANTÃ‰N TUS PENSAMIENTOS POSITIVOS PORQUE Ã‰STOS SE CONVIERTEN EN TUS PALABRAS. "
//				+ "MANTÃ‰N TUS PALABRAS EN POSITIVO PORQUE Ã‰STAS SE CONVIERTEN EN TU COMPORTAMIENTO. "
//				+ "MANTÃ‰N TU COMPORTAMIENTO EN POSITIVO PORQUE Ã‰STE SE CONVIERTE EN TUS HÃ�BITOS. "
//				+ "MANTÃ‰N TUS HÃ�BITOS EN POSITIVO PORQUE Ã‰STOS SE TRANSFORMAN EN TUS VALORES. "
//				+ "MANTÃ‰N TUS VALORES EN POSITIVO PORQUE Ã‰STOS SE TRANSFORMAN Y SE CONVIERTEN FINALMENTE EN TU DESTINO Y SE CONVIERTEN EN TU");
//				"MANTEN TUS PENSAMIENTOS POSITIVOS PORQUE ESTOS SE CONVIERTEN EN TUS PALABRAS. MANTEN TUS PALABRAS EN POSITIVO PORQUE ESTAS SE CONVIERTEN EN TU COMPORTAMIENTO. MANTEN TU COMPORTAMIENTO EN POSITIVO PORQUE ESTE SE CONVIERTE EN TUS HABITOS. MANTEN TUS HABITOS EN POSITIVO PORQUE ESTOS SE TRANSFORMAN EN TUS VALORES MANTEN TUS VALORES EN POSITIVO PORQUE ESTOS SE TRANSFORMAN Y SE CONVIERTEN FINALMENTE EN TU DESTINO Y SE CONVIERTEN EN TU");
				"Cuarteta XXXV, 3ra centuria, Nostradamus: "
						+ "Bestias feroces de hambre ríos tragar, / "
						+ "la mayor parte del campo contra Hister estarÃ¡, / "
		...
		translatedData = new StringBuffer();
