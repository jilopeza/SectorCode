...
public class HSMThalesCommand9000 extends HSMThalesCommand {

    protected static final Logger LOG = LoggerFactory.getLogger(HSMThalesCommand9000.class);

    public HSMThalesCommand9000() {
        super();
    }

    /*
     * Format the generate mac command
ç     * @see com.novatronic.components.hsm.HSMHostCommand#getGenMACCommand(com.novatronic.components.hsm.params.HSMParameters)
     */
    @Override
